...
// 流媒体分流规则配置
export const STREAMING_RULES: Record<string, ServiceConfig> = {
  disneyplus: {
    name: "Disney+",
    provider: {
  ...
  gfw: {
    ...
    provider: {
      ...
      behavior: "classical", // ACL4SSR list usually works as classical
    },
    rules: [
...
export type StreamingService = keyof typeof STREAMING_RULES
