...
| 类别                | 服务                                                                                                                                                               |
| ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **流媒体**    | 🎬 Netflix, 📺 Disney+, 🎵 Spotify, 📺 YouTube, 🎵 TikTok, 🎮 Twitch, 📺 Prime Video, 🎭 HBO Max, 🎬 Emby, 🐉 巴哈姆特, 📺 Bilibili (港澳台), 🎬 国外流媒体 (通用) |
| **AI & 工具** | 🤖 OpenAI (ChatGPT), ✈️ Telegram, 🔍 Google, 🐙 GitHub, 💼 LinkedIn                                                                                              |
| **生态系统**  | 🍎 Apple, 🪟 Microsoft, 🎮 Steam                                                                                                                                   |
| **其他**      | 🏛️ 国外政府网站, 🧱 GFW 列表, 🌐 国外流量 (通用)                                                                                                                 |
...
- **PASSWORD**: 设置访问密码。配置后，用户必须输入密码才能访问网页或使用 API。
  - **Vercel**: 在 Project Settings -> Environment Variables 中添加 `PASSWORD` 变量。
  - **Docker**: 在 `docker-compose.yml` 中修改 `PASSWORD` 变量。
